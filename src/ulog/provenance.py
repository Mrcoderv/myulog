...
class ProvenanceTracker:
    ...
    def enrich(
        self, data: Dict[str, Any], raw_message: str, parse_result: ParseResult, parser: BaseParser
    ) -> Dict[str, Any]:
    ...
    def create_meta(
        ...
        meta = {
            "raw_message": raw_message,
            "parse": {"parser_name": parser_name, "parser_version": parser_version, "confidence": confidence, "ok": ok},
        }
