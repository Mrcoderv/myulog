...
class DataLoadPattern(Pattern):
    ...
    regex = re.compile(r"\[Data\](?:\[(?P<level>INFO|WARNING|ERROR|DEBUG|WARN)\])?\s+(?P<message>.+)", re.IGNORECASE)
...
class PreprocPattern(Pattern):
    ...
    regex = re.compile(r"\[Preproc\](?:\[(?P<level>INFO|WARNING|ERROR|DEBUG|WARN)\])?\s+(?P<message>.+)", re.IGNORECASE)
...
class ModelPattern(Pattern):
    ...
    regex = re.compile(r"\[Model\](?:\[(?P<level>INFO|WARNING|ERROR|DEBUG|WARN)\])?\s+(?P<message>.+)", re.IGNORECASE)
